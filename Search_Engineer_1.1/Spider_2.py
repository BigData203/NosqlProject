...
if __name__ == "__main__":
    ...
    # str1='1'
    # str2='2'
    # root_url = "https://baike.baidu.com/item/"+ urllib.parse.quote(str1)
    # root_url2 = "https://baike.baidu.com/item/"+ urllib.parse.quote(str2)
    # # root_url ="https://baike.baidu.com/item/%E5%B8%B8%E5%B7%9E%E5%A4%A7%E5%AD%A6"
    # k.append(root_url)
    # k.append(root_url2)

    k = []
    data = xd.open_workbook('CrawlKey.xlsx') #打开excel表所在路径
    sheet = data.sheet_by_name('Sheet1')  #读取数据，以excel表名来打开
    d = []
    for r in range(sheet.nrows): #将表中数据按行逐步添加到列表中，最后转换为list结构
        data1 = []
        for c in range(sheet.ncols):
            root_url = "https://baike.baidu.com/item/" + urllib.parse.quote(sheet.cell_value(r,c))
            k.append(root_url)
            print(root_url)
            # time.sleep(0.5)
